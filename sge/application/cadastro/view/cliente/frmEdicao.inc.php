...
?>
<body onload="validapermissao(<?php echo $_SESSION['bazar_userPermissao']; ?>);">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <form role="form" action="?module=cadastro&acao=update_cliente" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                <input name="est_cod" type="hidden" class="form-control blockenter" id="est_cod" value="<?php echo $result[0]['est_cod'] ?>" />
