<?php
    ...
    $sql = "SELECT * FROM sim WHERE sim_cod =".$_POST['param_0'];
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <form role="form" action="?module=cadastro&acao=update_sim" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                <input type="hidden" name="sim_cod" value="<?php echo $_POST['param_0']?>">

                <div class="row form-group">
                    <div class="col-sm-5">
                        <label class="control-label" for="sim_responsavel">Vet. responsável:</label>
                        <input name="sim_responsavel" type="text" class="form-control blockenter" id="sim_responsavel" style="text-transform:uppercase;" value="<?php echo $result[0]['sim_responsavel']?>" required />
                    </div>

                    <div class="col-sm-2">
                        <label class="control-label" for="sim_email">E-mail:</label>
                        <input name="sim_email" type="tel" class="form-control blockenter" id="sim_email" value="<?php echo $result[0]['sim_email']?>" required />
                    </div>

                    <div class="col-sm-2">
                        <label class="control-label" for="sim_telefone">Telefone:</label>
                        <input name="sim_telefone" type="tel" class="form-control blockenter" id="sim_telefone" style="text-transform:uppercase;"  value="<?php echo $result[0]['sim_telefone']?>" required />
                    </div>     
