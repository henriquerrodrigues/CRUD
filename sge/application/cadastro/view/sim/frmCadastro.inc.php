        ...
        <div class="ibox-content">
            ...
            <form role="form" action="?module=cadastro&acao=grava_sim" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                ...
                <div class="row form-group">
                    <div class="col-sm-6">
                        <label class="control-label" for="bazar_titulo">Título:</label>
                        <input name="bazar_titulo" type="text" class="form-control blockenter" id="bazar_titulo" style="text-transform:uppercase;" required />
                    </div>

                    <div class="col-sm-6">
                        <label class="control-label" for="bazar_responsavel">Vet. responsável:</label>
                        <input name="bazar_responsavel" type="text" class="form-control blockenter" id="bazar_responsavel" style="text-transform:uppercase;" required />
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-4">
                        ...
                        <input name="bazar_email" type="tel" class="form-control blockenter" id="bazar_email" required />
                    </div>
                    
                    <div class="col-sm-4">
                        <label class="control-label" for="bazar_telefone">Telefone:</label>
                        <input name="bazar_telefone" type="tel" class="form-control blockenter" id="bazar_telefone" style="text-transform:uppercase;" required />
                    </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-12">
                        <label for="bazar_plano">Plano de Trabalho:</label>
                        <input type="file" name="bazar_plano" class="filestyle" id="bazar_plano">
                    </div>
                </div>
