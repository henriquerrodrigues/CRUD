                ...
                <div class="row form-group">
                    ...
                    ?>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-4" id="cid_cod">
                                <label class="control-label" for="cid_cod">Cidade:</label>
                                <select class="form-control selectpicker" data-live-search="true" data-size="6" name="set_cod" id="cid_cod">
                                    <option value="">-- Selecione --</option>
                                    <?php
                                        for ($i = 0; $i < count($cidade); $i++) {
                                            
                                            if($result[0]['cid_cod'] == $cidade[$i]['cid_cod']){
                                                echo '<option value="'.$cidade[$i]['cid_cod'].'" selected>' . $cidade[$i]['cid_nome'] . ' - '.$cidade[$i]['est_uf'].'</option>';
                                            }else{
                                                echo '<option value="'.$cidade[$i]['cid_cod'].'">' . $cidade[$i]['cid_nome'] . ' - '.$cidade[$i]['est_uf'].'</option>';
                                            }
                                        }
                                    ?>
                                </select>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-4">
                                <label class="control-label" for="cid_cod">Cidade:</label>
                                <select class="form-control selectpicker" data-live-search="true" data-size="6" name="cid_cod" id="set_cod">
                                    <option value="">-- Selecione --</option>
                                    <?php
                                        for ($i = 0; $i < count($cidade); $i++) {
                                            if($result[0]['cid_cod'] == $cidade[$i]['cid_cod']){
