...
// $sql = "SELECT * FROM usuario AS u INNER JOIN usuario_permissao AS p ON u.upe_codigo = p.upe_codigo WHERE u.usu_situacao = 1";
// $ati = $data->find('dynamic', $sql);

// $sql = "SELECT * FROM usuario AS u INNER JOIN usuario_permissao AS p ON u.upe_codigo = p.upe_codigo WHERE usu_situacao = 0";
                        ...
                        <div class="panel-body">
                            <div class="table-responsive" style="overflow-x: initial;">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                        if ($_SESSION['bazar_userPermissao'] == 1) {
