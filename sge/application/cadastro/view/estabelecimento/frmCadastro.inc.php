<?php
    ...
    $sql = "SELECT sim_cod, sim_titulo, sim_responsavel FROM sim WHERE sim_situacao = 1";
                ...
                <?php if($_SESSION['sim_userPermissao'] == 1){?>
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12">
                            ...
                            <select class="form-control selectpicker" data-live-search="true" data-size="6" id="sim_cod" name="sim_cod" required>
                                <option value="">-- Selecione --</option>
                                <?php
                                    for ($i = 0; $i < count($sim); $i++) {
                                        echo '<option value="' . $sim[$i]['sim_cod'] . '">' . $sim[$i]['sim_titulo'] . ' - '.$sim[$i]['sim_responsavel'].'</option>';
                                    }
                                ?>
                            </select>
                        </div>
